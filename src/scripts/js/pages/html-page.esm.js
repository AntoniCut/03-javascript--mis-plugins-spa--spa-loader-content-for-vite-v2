/*
    ...
    *  Renderiza contenido en html-demo.html tras la carga del plugin SPA v3.
*/
...
export const PAGE_ESM_FEATURES = Object.freeze([
    ...
    },
    {
        ...
        "text": "El módulo ESM se carga cuando layoutMain ya está en el DOM."
    },
    {
        "icon": "📡",
        "title": "Evento spa:route-loaded",
        "text": "Integración con el ciclo de vida del plugin SPA v3."
    }
]);
